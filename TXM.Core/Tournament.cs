...
namespace TXM.Core
{
	...
	public class Tournament
	{
		...
		public Tournament (int t3ID, string name, string byeText, string wonByeText, string imperiumText, string GOEPPversion = "")
			: this (name, t3ID, GOEPPversion, true, 100, TournamentCut.NoCut, byeText, wonByeText, imperiumText)
		{
		}
		...
		public Tournament (string name, int maxSquadPoints, TournamentCut cut, string byeText, string wonByeText, string imperiumText)
			: this (name, 0, "", true, maxSquadPoints, cut, byeText, wonByeText, imperiumText)
		{
		}
