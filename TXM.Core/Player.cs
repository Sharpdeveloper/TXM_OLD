...
namespace TXM.Core
{
	...
	public class Player
	{
		...
		public int PointsDestroyed { get; private set; }

		public int PointsLost { get; private set; }

		public int PointsOfEnemies { get; private set; }

		public int PointOfSquad { get; set; }

		public int MarginOfVictory { get; private set; }
		...
		public Player (Player p) : this (p.Name, p.Forename, p.Nickname, p.Team, p.City, p.Wins, p.ModifiedWins, p.Looses, p.Draws, p.Points, p.PointsDestroyed, p.PointsLost, p.PointsOfEnemies, p.PointOfSquad, p.MarginOfVictory, p.Faction, p.Freeticket, p.Paired, p.WonFreeticket, p.T3ID, p.Rank, p.ArmyRank, p.Payed, p.SquadListGiven, p.Nr)
		{
		...
		public Player (int t3ID, string forename, string name, string nickname, string faction, string city, string team, bool payed, bool armylistgiven, int pointOfSquad = 100)
			: this (name, forename, nickname, team, city, 0, 0, 0, 0, 0, 0, 0, 0, pointOfSquad, 0, faction, false, false, false, t3ID, 0, 0, payed, armylistgiven)
		{
		}
